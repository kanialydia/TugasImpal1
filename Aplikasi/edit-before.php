...
<html>
	...
	<body class="is-preload">
		...
		<!-- Nav -->
			...
			<div class="inner">
				<div class="content">
			<p><a href="lost.php">Kembali,  </a>  <a href="admin.php">Halaman Utama.</a></p>	
				<?php
			...
			if ($_SERVER['REQUEST_METHOD'] == 'POST' ){
				...
				if (empty($arrayError)){
					...
					if (mysqli_affected_rows($dbkoneksi) == 1){
						echo '<p>  BERHASIL DIEDIT. <a href="lost.php">Kembali</a>, <a href="admin.php">Halaman Utama</a>.</p>';
					}else{
				...
				if(mysqli_num_rows ($hasil) == 1){
					...
					//form edit
					echo '
						<form action="edit-before.php" method="post">
				...
				<p><a href="lost.php">Batal Edit</a></p>	
			</div>
			</div>
			</div>
			</section>
